...
void pwrLeftBase(double voltPerc);   //directly run voltage into left base motors, takes in a
                                     //percentage from -100 to 100
void pwrRightBase(double voltPerc);  //directly run voltage into right base motors, takes in a
                                     //percentage from -100 to 100
