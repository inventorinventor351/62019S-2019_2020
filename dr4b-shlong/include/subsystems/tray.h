...
#define TRAY_FULLY_DOWN 350 //tray potentiomter value when tray is all the way down
#define TRAY_FULL_UP 1725 //tray potentiometer value when tray is all the way up
