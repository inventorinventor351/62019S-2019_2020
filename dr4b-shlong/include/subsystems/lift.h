...
#define LIFT_FULLY_DOWN 0 //lift potentiomter value when lift is all the way down
#define LIFT_FULL_UP 1000 //lift potentiometer value when lift is all the way up
