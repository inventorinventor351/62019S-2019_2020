...
void PID::setOutputBounds(double _minOutput, double _maxOutput) {
...
double PID::run() {
    ...
    output = (kP * error) + (kI * integral) - (kD * derivative); //calculate output by summing all components of FPID
